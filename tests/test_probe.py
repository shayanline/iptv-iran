...
class TLSVerification(unittest.TestCase):
    def test_stream_probe_requires_valid_certificates(self):
        self.assertTrue(hasattr(probe, "PROBE_SSL_CTX"))
        self.assertTrue(probe.PROBE_SSL_CTX.check_hostname)
        self.assertEqual(probe.PROBE_SSL_CTX.verify_mode, ssl.CERT_REQUIRED)
