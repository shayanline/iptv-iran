...
198 Iranian and Persian language television channels, as M3U playlists you can paste
...
![Channels](https://img.shields.io/badge/channels-198-1f6feb)
...
|:--|:--|:--|
| **Everything** | All 198 channels, one stream each | `https://raw.githubusercontent.com/shayanline/iptv-iran/main/playlists/iran.m3u` |
| **Worldwide** | The 191 channels that play anywhere | `https://raw.githubusercontent.com/shayanline/iptv-iran/main/playlists/iran-global.m3u` |
...
| Satellite · News | 15 | `https://raw.githubusercontent.com/shayanline/iptv-iran/main/playlists/categories/sat-news.m3u` |
...
1 4K, 59 FHD, 43 HD, 83 SD, 12 unknown.

Logos for 136 channels are stored in this repository rather than linked from
...
198 channels in 14 categories, from 638 working streams.
...
<details>
<summary><b>Satellite · News</b> &nbsp; 15 channels</summary>
...
۱۹۸ شبکه تلویزیونی ایرانی و فارسی‌زبان، به شکل پلی‌لیست M3U که مستقیم در
...
| پلی‌لیست | محتوا | لینک |
|:--|:--|:--|
| **همه شبکه‌ها** | هر ۱۹۸ شبکه، برای هرکدام یک استریم | `https://raw.githubusercontent.com/shayanline/iptv-iran/main/playlists/iran.m3u` |
| **قابل پخش در همه‌جا** | آن ۱۹۱ شبکه‌ای که از هر کشوری باز می‌شود | `https://raw.githubusercontent.com/shayanline/iptv-iran/main/playlists/iran-global.m3u` |
...
| ماهواره‌ای · خبری | ۱۵ | `https://raw.githubusercontent.com/shayanline/iptv-iran/main/playlists/categories/sat-news.m3u` |
...
۱ 4K، ۵۹ FHD، ۴۳ HD، ۸۳ کیفیت معمولی، ۱۲ نامشخص.

لوگوی ۱۳۶ شبکه داخل همین مخزن نگه داشته می‌شود و از جای دیگری لینک
...
۱۹۸ شبکه در ۱۴ دسته، از ۶۳۸ استریم سالم.
...
<details>
<summary><b>ماهواره‌ای · خبری</b> &nbsp; ۱۵ شبکه</summary>
