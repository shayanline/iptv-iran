...
The current publication contains 203 channels in 13 categories from 624 tracked working or grace period streams. Read the [English channel catalogue](CHANNELS.md) or the [Persian channel catalogue](CHANNELS.fa.md).
...
نسخه فعلی شامل ۲۰۳ شبکه در ۱۳ دسته‌بندی است. این شبکه‌ها از میان ۶۲۴ استریم فعال و استریم‌هایی که موقتاً دوباره بررسی می‌شوند انتخاب شده‌اند. برای دیدن جزئیات، [فهرست فارسی شبکه‌ها](CHANNELS.fa.md) یا [فهرست انگلیسی شبکه‌ها](CHANNELS.md) را باز کنید.
