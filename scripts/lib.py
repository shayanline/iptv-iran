...
# Discovery documents and logo hosts sometimes present expired or mismatched certificates.
# Their metadata is read permissively, while probe.py uses a strict context for media URLs
# because playback clients must be able to validate a stream's certificate.
