...
from lib import (BUILD, CANDIDATES, DATA, HERE, UA, install_public_dns, log, read_json,
                 write_json)
...
PROBE_SSL_CTX = ssl.create_default_context()
_opener = urllib.request.build_opener(
    urllib.request.HTTPCookieProcessor(http.cookiejar.CookieJar()),
    urllib.request.HTTPSHandler(context=PROBE_SSL_CTX))
