...
CATEGORIES = [
    ...
    ("sat-general", "Satellite · General", "ماهواره‌ای · عمومی",
     "Mixed schedules, including variety, talk shows, comedy and reality television."),
    ("sat-movies", "Satellite · Movies & Series", "ماهواره‌ای · فیلم و سریال",
     "Film and drama channels, including dubbed foreign titles."),
    ("sat-news", "Satellite · News & Politics", "ماهواره‌ای · خبر و سیاست",
     "News, current affairs and political commentary channels."),
    ...
    ("sat-documentary", "Satellite · Knowledge & Lifestyle", "ماهواره‌ای · دانش و سبک زندگی",
     "Documentary, education, health, travel, business and lifestyle channels."),
...
GENRE_MAP = {
    ...
    "entertainment": "sat-general", "comedy": "sat-general",
    "lifestyle": "sat-documentary", "cooking": "sat-documentary",
    "culture": "sat-general", "shop": "sat-general",
    "general": "sat-general",
}
